...
const client = new Client({
  phoneNumber: '966568110721', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "Amer", lid: "966568110721@lid", jid: "972569311531@s.whatsapp.net" },
  // Owner 2
    { name: "كورولو", lid: "966551108565@lid", jid: "201144480436@s.whatsapp.net" },
  // Owner 3
    { name: "k", jid: "201033024135@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "s", jid: "201050079089@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
